...
\begin{equation}
V_{out} = \frac{(V_{in-} + V_m - V_m + V_{out} + 2(g_m)(V_m)(g_0))g_m}{2} +  \frac{V_m + V_{out} + 2(g_m)(V_m)(g_0)}{2}
\end{equation}

\begin{equation}
V_{out} (\frac{1}{g_0} - \frac{1}{g_0})  = \frac{-V_a }{g_0} + V_{in-}g_m - (V_m) gm
\end{equation}
...
\includegraphics[width=6in]{images/Problem5.png} \\
